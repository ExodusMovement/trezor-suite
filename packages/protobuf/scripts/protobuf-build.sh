...
yarn workspace @exodus/trezor-protobuf g:prettier --write {messages.json,src/messages.ts} 
yarn workspace @exodus/trezor-protobuf g:eslint --fix ./src/messages.ts
